...
import static org.snomed.otf.reasoner.server.service.model.SnomedOntologyUtils.PREFIX_ROLE;
...
public final class RelationshipDefinition extends AnnotatedDefinition implements Serializable {
	...
	public RelationshipDefinition(final long destinationId) {
		this(Collections.emptySet(), LongConcepts.IS_A_ID, destinationId, false, false);
	}
	...
	@Override public String toString() {
		return "RelationshipDefinition [typeId=" +
				typeId +
				", destinationId=" +
				destinationId +
				", negated=" +
